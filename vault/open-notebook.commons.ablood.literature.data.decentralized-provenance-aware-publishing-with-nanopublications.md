...
## Relevance
- Provenance is treated as a first-class citizen.
- Scientific claims become individually citable.
- Supports **FAIR** principles.
- Decentralized publishing improves robustness and long-term availability.
- RDF and Linked Data provide interoperability.
- REST APIs expose semantic data without requiring expensive SPARQL endpoints.